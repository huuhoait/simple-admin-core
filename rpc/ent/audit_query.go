...
func (aq *AuditQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (aq *AuditQuery) FirstIDX(ctx context.Context) uint64 {
...
func (aq *AuditQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (aq *AuditQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (aq *AuditQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (aq *AuditQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := aq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (aq *AuditQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(audit.Table, audit.Columns, sqlgraph.NewFieldSpec(audit.FieldID, field.TypeUint64))
	_spec.From = aq.sql
